...
'dom_CONTENT_FIELD_DESCRIPTION' => 'Para el sitio web, usted puede escoger el sitio web primario o cualquier i-bay como contenido.',
'dom_DOMAIN_NAME_VALIDATION_ERROR' => 'Error: caracteres erróneos o faltantes en el nombre del dominio [_1]. El nombre del dominio debe contener una o más letras, números, puntos y signos menos. No es posible crear el nuevo dominio.',
'dom_DOMAIN_DESCRIPTION_VALIDATION_ERROR' => 'Error: caracteres erróneos o faltantes en la descripción del dominio [_1]. No se creó el nuevo dominio.',
'dom_DOMAIN_IN_USE_ERROR' => 'Error: el dominio [_1] ya está en uso. No se creó el nuevo dominio.',
'dom_SYSTEM_DOMAIN_ERROR' => 'Error: el dominio [_1] es el nombre del dominio de su sistema. No puede tener un dominio con el mismo nombre. No se creó el nuevo dominio.',
'dom_SUCCESSFULLY_CREATED' => 'Se creó con éxito el dominio [_1]. Ahora se está reiniciando el servidor web. Los vínculos en esta página estarán inactivos hasta que se complete el reinicio del servidor web.',
'dom_MODIFY_TITLE' => 'Modificar dominio',
'dom_NONEXISTENT_DOMAIN_ERROR' => 'Error: [_1] no es un dominio existente.',
'dom_SUCCESSFULLY_MODIFIED' => 'Se modificó con éxito el dominio [_1]. Ahora se está reiniciando el servidor web. Los vínculos en esta página estarán inactivos hasta que se complete el reinicio del servidor web.',
'dom_REMOVE_TITLE' => 'Eliminar dominio',
'dom_REMOVE_DESCRIPTION' => '  Está a punto de eliminar el dominio [_1] ([_2]). 
...
'dom_DESC_NAMESERVERS' => 'Puede seleccionar si este dominio es resuelto localmente, por el servidor corporativo de DNS, o resolverlo por medio de un servidor DNS de Internet. El predeterminado será el correcto para la mayoría de las redes.',
'dom_LABEL_NAMESERVERS' => 'Servidores DNS de dominio',
...
'dom_DOMAINS_PAGE_CORPORATE_DNS' => 'Modificar la configuración de DNS corporativa',
