# ORPHANED (no longer in proxy_en.lex; kept for reference, commented out by lex-to-po.pl): 'prx_Proxy settings' => 'Ρυθμίσεις μεσολαβητή proxy',
...
'prx_BLOCKED' => 'Αποκλεισμένο',
'prx_TITLE' => 'Ρυθμίσεις διαμεσολαβητή',
'Proxy settings' => 'Ρυθμίσεις διαμεσολαβητή',
'prx_Proxy' => 'Διακομιστής μεσολάβησης',
