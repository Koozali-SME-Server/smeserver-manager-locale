'pwd_DESCRIPTION' => ' Para trocar a senha de sua conta, por favor preencha o seguinte formulário. Você precisará fornecer o nome da conta, sua senha antiga, e a nova senha desejada (e precisará digitar sua nova senha duas vezes).
  ...
  <p>Se você não pode trocar sua senha porque esqueceu a antiga, seu administrador do servidor poderá resetar sua senha usando o <em>gerenciador do servidor</em>.</p>
...
'pwd_PASSWORD_CHANGE' => 'Alterar senha',
...
'pwd_ACCOUNT_PASSWORD_CHANGE' => 'Alterar senha da conta',
'pwd_PASSWORD_VERIFY_NEW' => 'Nova senha (confirmar):',
'pwd_PASSWORD_NEW' => 'Nova senha:',
