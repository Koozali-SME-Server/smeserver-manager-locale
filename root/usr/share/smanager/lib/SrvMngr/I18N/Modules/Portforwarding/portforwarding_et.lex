'pf_FORM_TITLE' => 'Seadista pordisuunamist',
'pf_FIRST_PAGE_DESCRIPTION' => '  You can use this panel to modify your firewall rules so as to open a specific port on this server and forward it to another port on another host. Doing so will permit incoming traffic to directly access a private host on your LAN. 
  ...
  ',
'pf_CREATE_RULE' => 'Lisa pordisuunamise reegel',
...
'pf_SHOW_FORWARDS' => 'Allpool on näha tabelit olemasolevate pordisuunamistega serveris.Click on the &quot;Remove&quot; link to remove the corresponding rule.',
'pf_NO_FORWARDS' => 'Süsteemis pole pordisuunamist rakendatud.',
...
'pf_LABEL_DESTINATION_PORT' => 'Asukoha port(id)',
'pf_LABEL_DESTINATION_HOST' => 'Asukoha hosti IP aadress',
# ORPHANED (no longer in portforwarding_en.lex; kept for reference, commented out by lex-to-po.pl): 'pf_LABEL_RULE_COMMENT' => 'Kommentaar',
# ORPHANED (no longer in portforwarding_en.lex; kept for reference, commented out by lex-to-po.pl): 'pf_LABEL_ALLOW_HOSTS' => 'Hostid',
# ORPHANED (no longer in portforwarding_en.lex; kept for reference, commented out by lex-to-po.pl): 'pf_Port forwarding' => 'Pordi suunamine',
'pf_SUCCESS' => 'Muudatused pordi suunamise reeglites edukalt salvestatud.',
'pf_RULE_COMMENT' => 'Kommentaar',
'pf_ALLOW_HOSTS' => 'Hostid',
