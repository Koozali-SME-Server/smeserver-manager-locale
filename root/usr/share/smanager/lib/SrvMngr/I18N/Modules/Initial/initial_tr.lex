...
'initial_FRAMES_BODY' => '  SME Sunucusuna Hoşheldiniz, küçük ve orta ölçekli işletmeler için önde gelen Linux dağıtımı <a href="https://wiki.koozali.org/" target="_blank">Koozali Foundation, Inc.</a>,kar amacı gütmeyen bir kuruluş, pazarlama ve SME Sunusu için yasal destek sağlamaktadır. 
  ...
  <p> Bu nedenle, maliyetleri karşılamak için küçük bir bağış bekliyoruz. </p>

  <p> <b> Lütfen <a href="https://wiki.koozali.org/donate" target="_blank">https://wiki.koozali.org/Donate</a> bağışta bulunun. </b></p>

  <p> Bu yazılımın KESİNLİKE GARANTİSİ YOKTUR. Lütfen <a href="/smanager/support" target="main">buraya tıklayarak</a> destek, garanti ve lisans bilgilerine gözatın. </p>
