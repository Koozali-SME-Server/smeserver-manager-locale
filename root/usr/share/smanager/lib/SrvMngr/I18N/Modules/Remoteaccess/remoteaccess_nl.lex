...
'rma_DESC_SERIAL_CONSOLE_ACCESS' => ' Seriële console U kunt toegang verlenen tot de server console vanaf een terminal die is aangesloten op een seriële poort van de server.',
