...
'rma_DESC_TELNET_ACCESS' => ' Impostazioni Telnet ATTENZIONE: Telnet è abilitato, ma non più supportato. Telnet non è sicuro e dovrebbe essere usato solo in circostanze in cui non esistono alternative. L\'opzione dovrebbe essere su {$NO_ACCESS} e dovrebbe essere utilizzato ssh in caso di accesso remoto. Una volta disabilitato, telnet non apparirà su questo schermo. ',
