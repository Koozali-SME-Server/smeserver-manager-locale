...
'pwd_FIELDS_REQUIRED' => 'Όλα τα πεδία είναι υποχρεωτικά',
...
'pwd_PASSWORD_CHANGE' => 'Αλλαγή κωδικού πρόσβασης',
# ORPHANED (no longer in userpassword_en.lex; kept for reference, commented out by lex-to-po.pl): 'pwd_RESET_PASSWORD_TITLE' => 'Επαναφορά κωδικού πρόσβασης χρήστη',
'pwd_ACCOUNT_PASSWORD_CHANGE' => 'Αλλαγή κωδικού πρόσβασης λογαριασμού',
'pwd_PASSWORD_VERIFY_NEW' => 'Νέος κωδικός πρόσβασης (επιβεβαίωση):',
'pwd_PASSWORD_NEW' => 'Νέος κωδικός πρόσβασης:',
'pwd_PASSWORD_OLD' => 'Παλιός κωδικός πρόσβασης:',
'pwd_PASSWORD_RESET' => 'Επαναφορά κωδικού πρόσβασης',
...
'pwd_YOUR_ACCOUNT' => 'Ο λογαριασμός σας:',
