...
'rma_DESC_SERIAL_CONSOLE_ACCESS' => ' Konsol Serial Anda dapat membolehkan akses ke konsol server dari sebuah terminal yang terhubung melalui serial port pada server.',
