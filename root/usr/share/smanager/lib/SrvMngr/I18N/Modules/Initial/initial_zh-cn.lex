...
# ORPHANED (no longer in initial_en.lex; kept for reference, commented out by lex-to-po.pl): 'initial_NOFRAMES_BODY' => ' 欢迎使用 SME Server。这是个自由软件。请<a href="/smanager/support" target="main">点击此处</a>查看支持细节、保证和许可信息 。
#
