...
'pf_LABEL_PROTOCOL' => 'Protokół',
'pf_LABEL_DESTINATION_PORT' => 'Destination Port(s)',
'pf_LABEL_DESTINATION_HOST' => 'Destination Host IP Address',
# ORPHANED (no longer in portforwarding_en.lex; kept for reference, commented out by lex-to-po.pl): 'pf_LABEL_RULE_COMMENT' => 'Komentarze',
# ORPHANED (no longer in portforwarding_en.lex; kept for reference, commented out by lex-to-po.pl): 'pf_LABEL_ALLOW_HOSTS' => 'Wszystkie projekty',
...
'pf_RULE_COMMENT' => 'Komentarze',
'pf_ALLOW_HOSTS' => 'Wszystkie projekty',
