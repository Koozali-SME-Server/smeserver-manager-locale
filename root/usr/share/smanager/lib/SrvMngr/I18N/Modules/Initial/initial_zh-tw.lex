'initial_FORM_TITLE' => '歡迎來到伺服器管理員',
'initial_FRAMES_BODY' => '  Welcome to SME Server, the leading Linux distribution for small and medium enterprises. SME Server is brought to you by <a href="https://www.koozali.org/" target="_blank">Koozali Foundation, Inc.</a>, a non-profit corporation that exists to provide marketing and legal support for SME Server. 
  ...
  <p> a) If you are a school, a church, a non-profit organisation or an individual using SME for private purposes, we would appreciate you to contribute within your means toward the costs associated with hosting, maintenance and development. </p>
  ...
  ',
# ORPHANED (no longer in initial_en.lex; kept for reference, commented out by lex-to-po.pl): 'initial_NOFRAMES_BODY' => '  Welcome to the SME Server. This software comes with ABSOLUTELY NO WARRANTY. Please <a href="/smanager/support" target="main">click here</a> to view detailed support, warranty and licensing information. 
#
