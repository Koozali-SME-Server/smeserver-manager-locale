'pwd_DESCRIPTION' => ' For å endre ditt konto passord må du fylle ut føgende skjema. Du må oppgi navnet på kontoen, ditt gamle passord, og det ønskede nye passordet (du må skrive det nye to ganger). Har du glemt ditt gamle passord, kan den lokale system administratoren nulstille passordet dit via server manager. ',
...
'pwd_FIELDS_REQUIRED' => 'Alle felt er obligatoriske',
...
'pwd_PASSWORD_CHANGE' => 'Endre passord',
# ORPHANED (no longer in userpassword_en.lex; kept for reference, commented out by lex-to-po.pl): 'pwd_RESET_PASSWORD_TITLE' => 'Tilbakestill brukerpassord',
'pwd_ACCOUNT_PASSWORD_CHANGE' => 'Endre kontopassord',
'pwd_PASSWORD_VERIFY_NEW' => 'Nytt passord (bekreft):',
'pwd_PASSWORD_NEW' => 'Nytt passord:',
'pwd_PASSWORD_OLD' => 'Gammelt passord:',
'pwd_PASSWORD_RESET' => 'Tilbakestill passord',
