...
'pse_CURRENT_PSEUDONYMS' => '<b>Nimekiri olemasolevatest aliastest</b>',
...
'pse_VALID_PSEUDONYM_NAMES' => ' Pseudonüüm võib koosneda ainult väiketähtedest, numbritest, sidekriipsust ja alakriipsust ning peab algama väiketähe või numbriga. Näiteks "müük", john.holland", "123" või "emaili-administraator" on kõik sobivad pseudonüümid aga ei sobi näiteks "John Smith"<p> Samas võid luu aka emaili aliase kontole ja (virtuaal) domeenile mis on serveris kirjeldatud. Näiteks "fred@virtuaaldomeen.ee" saab edastada "mary" ( või mõnele teisele kaontole)</p> ',
