...
# ORPHANED (no longer in backup_en.lex; kept for reference, commented out by lex-to-po.pl): 'bac_BACKUP_DESC' => ' <p>Ο διακομιστής προσφέρει δύο τρόπους αντιγραφής ασφαλείας και επαναφοράς του: χρησιμοποιώντας την τοπική σας επιφάνεια εργασίας ή έναν οδηγό μαγνητικής ταινίας.</p>
#
...
# ORPHANED (no longer in backup_en.lex; kept for reference, commented out by lex-to-po.pl): 'bac_TAPE_BACKUPS_ENABLED' => ' Η αντιγραφή ασφαλείας σε ταινία είναι επί του παρόντος ενεργοποιημένη. ',
...
# ORPHANED (no longer in backup_en.lex; kept for reference, commented out by lex-to-po.pl): 'bac_TAPE_BACKUPS_DISABLED' => ' Η αντιγραφή ασφαλείας σε ταινία είναι απενεργοποιημένη ',
...
# ORPHANED (no longer in backup_en.lex; kept for reference, commented out by lex-to-po.pl): 'bac_Backup or restore' => 'Αντιγραφή ασφαλείας ή επαναφορά',
...
# ORPHANED (no longer in backup_en.lex; kept for reference, commented out by lex-to-po.pl): 'bac_WORKSTN_BACKUPS_DISABLED' => ' Η αντιγραφή ασφαλείας σε σταθμό εργασίας είναι απενεργοποιημένη ',
# ORPHANED (no longer in backup_en.lex; kept for reference, commented out by lex-to-po.pl): 'bac_WORKSTN_BACKUPS_ENABLED' => ' Η αντιγραφή ασφαλείας σε σταθμό εργασίας είναι επί του παρόντος ενεργοποιημένη. ',
