...
'log_LOG_FILE_EMPTY' => 'Log file "[_1]" kosong!',
'log_VIEWING_TIME' => 'Dilihat pada [_1].',
'log_MATCH_HEADER' => 'Menampilkan baris yang matching: "[_1]".',
'log_HIGHLIGHT_HEADER' => 'Menyoroti baris yang cocok dengan : "[_1]".',
'log_NO_MATCHING_LINES' => 'Tidak ada baris yang cocok yang ditampilkan',
'log_FILENAME_ERROR' => ' Error saat menentukan nama log file.

  <p>Jenis laporan invalid "[_1]".</p>
