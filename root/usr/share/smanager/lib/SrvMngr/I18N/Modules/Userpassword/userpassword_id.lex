'pwd_DESCRIPTION' => ' Untuk mengubah password anda, silakan isi form dibawah ini. Anda akan perlu menyediakan nama akun anda, password lama, dan password baru yang anda inginkan. (Anda harus mengisikan password baru dua kali.)
  ...
  <p>Jika anda tidak dapat mengubah password karena anda lupa password lama, system administrator lokal anda dapat mengubah password anda menggunakan <em>server manager</em>.</p>
...
'pwd_FIELDS_REQUIRED' => 'Semua kolom wajib diisi',
...
'pwd_PASSWORD_CHANGE' => 'Ubah Kata Sandi',
# ORPHANED (no longer in userpassword_en.lex; kept for reference, commented out by lex-to-po.pl): 'pwd_RESET_PASSWORD_TITLE' => 'Atur ulang sandi pengguna',
'pwd_ACCOUNT_PASSWORD_CHANGE' => 'Ubah kata sandi akun',
'pwd_PASSWORD_VERIFY_NEW' => 'Kata sandi baru (konfirmasi):',
'pwd_PASSWORD_NEW' => 'Kata sandi baru:',
'pwd_PASSWORD_OLD' => 'Kata sandi lama:',
'pwd_PASSWORD_RESET' => 'Atur ulang kata sandi',
