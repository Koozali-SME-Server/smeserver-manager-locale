...
'usr_PASSWORD_CHANGE_SUCCEEDED' => 'הסיסמא של משתמש "{$acctName}" שונתה בהצלחה.',
'usr_LOCK_DESC' => 'אתה עומד לנעול את חשבון המשתמש',
'usr_LOCKED_ACCOUNT' => 'החשבון של משתמש "{$acctName}" ננעל בהצלחה.',
'usr_NO_SUCH_USER' => 'Error: the user account "{$acctName}" does not exist.',
