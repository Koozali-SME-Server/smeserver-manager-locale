...
# ORPHANED (no longer in quota_en.lex; kept for reference, commented out by lex-to-po.pl): 'quo_UNABLE_TO_OPEN_ACCOUNTS' => 'Unable to open accounts db',
...
'quo_LIMIT_WITH_GRACE' => 'Limit okresu karencji',
'quo_LIMIT_WITH_GRACE_MB' => 'Limit okresu karencji',
'quo_ABS_LIMIT' => 'Absolutny limit',
'quo_ABS_LIMIT_MB' => 'Absolute limit (MB)',
'quo_CURRENT_USAGE' => 'Current usage (MB)',
# ORPHANED (no longer in quota_en.lex; kept for reference, commented out by lex-to-po.pl): 'quo_COULD_NOT_GET_UID' => 'Could not determine the uid for user:',
...
# ORPHANED (no longer in quota_en.lex; kept for reference, commented out by lex-to-po.pl): 'quo_Quotas' => 'Quotas',
