...
'wkg_DESC_SERVERNAME' => 'Enter the name that this server should use for Windows and Macintosh file sharing.',
'wkg_LABEL_SERVERNAME' => 'Server Name',
'wkg_DESC_PDC' => 'Should this server act as the workgroup and domain controller on your Windows network? You should leave this set to <b>No</b> if another server is already performing this role on your network.',
'wkg_LABEL_PDC' => 'Workgroup and Domain Controller',
'wkg_DESC_ROAM' => ' Should this server support roaming profiles? You should leave this set to the default of <b>No</b> unless you have experience administering server-based Windows roaming profiles and know that this feature is required. ',
