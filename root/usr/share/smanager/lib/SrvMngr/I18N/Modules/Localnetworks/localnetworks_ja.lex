# ORPHANED (no longer in localnetworks_en.lex; kept for reference, commented out by lex-to-po.pl): 'ln_Local networks' => 'ローカルネットワーク',
...
# ORPHANED (no longer in localnetworks_en.lex; kept for reference, commented out by lex-to-po.pl): 'ln_NETWORK_ADDRESS' => 'ネットワークアドレス',
'ln_SUBNET_MASK' => 'サブネットマスク',
'ln_INVALID_IP_ADDRESS' => '無効なIPアドレス',
'ln_INVALID_SUBNET_MASK' => '無効なサブネットマスク',
'ln_REMOVE_TITLE' => 'ローカルネットワークを削除',
...
# ORPHANED (no longer in localnetworks_en.lex; kept for reference, commented out by lex-to-po.pl): 'ln_DEFAULT' => 'デフォルト',
'ln_NUMBER_OF_HOSTS' => 'ホスト数',
...
'ln_ERROR_CREATING_NETWORK' => 'ネットワークの作成中にエラーが発生しました。',
...
'ln_ERROR_DELETING_NETWORK' => 'ネットワークの削除中にエラーが発生しました。',
# ORPHANED (no longer in localnetworks_en.lex; kept for reference, commented out by lex-to-po.pl): 'ln_NO_ADDITIONAL_NETWORKS' => '追加のネットワークはありません',
...
'ln_REMOVE_HOSTS_LABEL' => 'ネットワーク上のホストを削除',
'ln_LOCAL NETWORKS' => 'ローカルネットワーク',
'Local networks' => 'ローカルネットワーク',
'ln_LOCALNETWORK_ADD' => 'ネットワークを追加',
'ln_NO_SUCH_NETWORK' => '(en)Network not found in network db',
# ORPHANED (no longer in localnetworks_en.lex; kept for reference, commented out by lex-to-po.pl): 'ln_extra' => '[_1]/[_2]（ルーター [_3] 経由）',
