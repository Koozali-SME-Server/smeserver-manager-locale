...
# ORPHANED (no longer in remoteaccess_en.lex; kept for reference, commented out by lex-to-po.pl): 'rma_VALUE_ZERO_OR_POSITIVE' => 'La valeur doit être un entier supérieur ou égal à zéro.',
...
# ORPHANED (no longer in remoteaccess_en.lex; kept for reference, commented out by lex-to-po.pl): 'rma_ERR_NO_RECORD' => 'Impossible de trouver les informations relatives au gestionnaire du serveur dans la base de données de configuration.',
'Remote access' => 'Accès à distance',
# ORPHANED (no longer in remoteaccess_en.lex; kept for reference, commented out by lex-to-po.pl): 'rma_LABEL_SERIAL_CONSOLE_ACCESS' => 'Console sur port série',
# ORPHANED (no longer in remoteaccess_en.lex; kept for reference, commented out by lex-to-po.pl): 'rma_DESC_SERIAL_CONSOLE_ACCESS' => 'Vous pouvez autoriser l\'accès à la console du serveur à partir d\'un terminal relié à un port série du serveur. ',
# ORPHANED (no longer in remoteaccess_en.lex; kept for reference, commented out by lex-to-po.pl): 'rma_PORT1_ENABLED' => 'Activé sur le port série 1',
# ORPHANED (no longer in remoteaccess_en.lex; kept for reference, commented out by lex-to-po.pl): 'rma_PORT2_ENABLED' => 'Activé sur le port série 2',
# ORPHANED (no longer in remoteaccess_en.lex; kept for reference, commented out by lex-to-po.pl): 'rma_LABEL_PPTP_ACCESS' => 'Accès utilisateur par défaut via PPTP',
'rma_DESC_TELNET_ACCESS' => 'AVERTISSEMENT : Telnet est actuellement activé, mais cette fonctionnalité n\'est plus prise en charge. Intrinsèquement, Telnet n\'est pas sécurisé et nous vous recommandons de ne pas l\'utiliser, à moins que vous n\'ayez pas d\'autre alternative. Vous devriez définir cette option à "[_1]" et utiliser un terminal sécurisé (SSH) si l\'accès distant est nécessaire. Une fois désactivé, Telnet n\'apparaîtra plus sur cette page. ',
