...
'pwd_FIELDS_REQUIRED' => 'すべての項目は必須です',
...
'pwd_PASSWORD_CHANGE' => 'パスワード変更',
# ORPHANED (no longer in userpassword_en.lex; kept for reference, commented out by lex-to-po.pl): 'pwd_RESET_PASSWORD_TITLE' => 'ユーザーパスワードをリセット',
'pwd_ACCOUNT_PASSWORD_CHANGE' => 'アカウントパスワードの変更',
'pwd_PASSWORD_VERIFY_NEW' => '新しいパスワード（確認）:',
'pwd_PASSWORD_NEW' => '新しいパスワード:',
'pwd_PASSWORD_OLD' => '現在のパスワード:',
'pwd_PASSWORD_RESET' => 'パスワードの再設定',
