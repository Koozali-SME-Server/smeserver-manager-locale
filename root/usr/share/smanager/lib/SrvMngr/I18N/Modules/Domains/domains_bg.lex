...
'dom_DOMAIN_NAME_VALIDATION_ERROR' => 'Грешка: неочакван или липсващ символ в името на домейна [_1]. Името на домейна трябва да съдържа една или повече букви, цифри, точки и знаци минус. Домейна не бе създаден.',
'dom_DOMAIN_DESCRIPTION_VALIDATION_ERROR' => 'Грешка: неочакван или липсващ символ в описанието на домейна [_1]. Домейна не бе създаден.',
'dom_DOMAIN_IN_USE_ERROR' => 'Грешка: домейнът [_1] вече съществува. Домейна не бе създаден.',
'dom_SYSTEM_DOMAIN_ERROR' => 'Грешка: домейна [_1] е име на системния Ви домейн. Не можете да имате домейн със същото име. Домейна не бе създаден.',
'dom_SUCCESSFULLY_CREATED' => 'Домейна [_1] бе успешно създаден. Вашият web сървър сега се рестартира. Връзките в тази страница ще бъдат неактивни докато стартирането на web сървъра не завърши.',
'dom_MODIFY_TITLE' => 'Промяна на домейн',
'dom_NONEXISTENT_DOMAIN_ERROR' => 'Грешка: Домейна [_1] не съществува.',
'dom_SUCCESSFULLY_MODIFIED' => '[_1] беше успешно променен. Вашия web сървър се рестартира в момента. Връзките на страницата ще бъдат неактивни докато рестартирането на web сървъра не завърши.',
'dom_REMOVE_TITLE' => 'Премахване на домейн',
'dom_REMOVE_DESCRIPTION' => '  Вие възнамеряване да премахнете домейна [_1] ([_2]). 
...
'dom_DOMAINS_PAGE_CORPORATE_DNS' => 'Промяна на корпоративните DNS настройки',
