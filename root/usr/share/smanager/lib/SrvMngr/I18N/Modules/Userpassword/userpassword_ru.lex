...
'pwd_FIELDS_REQUIRED' => 'Все поля обязательны',
...
'pwd_PASSWORD_CHANGE' => 'Изменить пароль',
# ORPHANED (no longer in userpassword_en.lex; kept for reference, commented out by lex-to-po.pl): 'pwd_RESET_PASSWORD_TITLE' => 'Сбросить пароль пользователя',
'pwd_ACCOUNT_PASSWORD_CHANGE' => 'Изменить пароль аккаунта',
'pwd_PASSWORD_VERIFY_NEW' => 'Новый пароль (подтверждение):',
'pwd_PASSWORD_NEW' => 'Новый пароль:',
'pwd_PASSWORD_OLD' => 'Старый пароль:',
'pwd_PASSWORD_RESET' => 'Сбросить пароль',
...
'pwd_YOUR_ACCOUNT' => 'Ваша учётная запись:',
