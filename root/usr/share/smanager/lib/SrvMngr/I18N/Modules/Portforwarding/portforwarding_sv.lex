...
'pf_ERR_NO_MASQ_RECORD' => 'Kan inte hämta masq-posten från konfigurationsdatabasen.',
'pf_ERR_UNSUPPORTED_MODE' => 'Ej stödd mod.',
'pf_ERR_CANNOT_REMOVE_NORULE' => 'Kan inte ta bort en icke existerande regel.',
...
'pf_ERR_DUPRULE' => 'Denna regel har redan lagts till. den kan inte läggas till två gånger.',
