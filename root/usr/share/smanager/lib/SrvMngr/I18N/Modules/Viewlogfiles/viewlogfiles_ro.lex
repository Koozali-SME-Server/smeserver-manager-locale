...
'log_LOG_FILE_EMPTY' => 'Fișierul de log "[_1]" este gol!',
'log_VIEWING_TIME' => 'Vizualizat la [_1].',
'log_MATCH_HEADER' => 'Listare linii conforme filtru: "[_1]".',
'log_HIGHLIGHT_HEADER' => 'Ingrosare linii conforme: "[_1]".',
'log_NO_MATCHING_LINES' => 'Nici o linie nu e conforma cu filtrul.',
'log_FILENAME_ERROR' => ' Eroare în numele fișierului de log.

  <p>Tip de raport invalid "[_1]".</p>
