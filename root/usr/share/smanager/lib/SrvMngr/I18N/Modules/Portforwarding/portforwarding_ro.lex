...
# ORPHANED (no longer in portforwarding_en.lex; kept for reference, commented out by lex-to-po.pl): 'pf_LABEL_ALLOW_HOSTS' => 'Toate proiectele',
...
'pf_ALLOW_HOSTS' => 'Toate proiectele',
