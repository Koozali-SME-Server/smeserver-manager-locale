...
# ORPHANED (no longer in portforwarding_en.lex; kept for reference, commented out by lex-to-po.pl): 'pf_CREATE_PAGE_DESCRIPTION' => ' Pilih protokol, port yang ingin anda teruskan, the host tujuan, dan port dari host tujuan yang ingin anda teruskan. Jika anda ingin menentukan port range, masukkan batas bawah dan atas dipisahkan dengan strip. Port tujuan dapat dibiarkan kosong, yang mana akan menginstruksikan firewall agar membiarkan source port tidak diubah-ubah.
#
#  ',
...
# ORPHANED (no longer in portforwarding_en.lex; kept for reference, commented out by lex-to-po.pl): 'pf_LABEL_RULE_COMMENT' => 'Komentar',
# ORPHANED (no longer in portforwarding_en.lex; kept for reference, commented out by lex-to-po.pl): 'pf_LABEL_ALLOW_HOSTS' => 'Hosts',
# ORPHANED (no longer in portforwarding_en.lex; kept for reference, commented out by lex-to-po.pl): 'pf_Port forwarding' => 'Penerusan port',
'pf_SUCCESS' => 'Perubahan aturan penerusan port telah berhasil disimpan.',
'pf_RULE_COMMENT' => 'Komentar',
'pf_ALLOW_HOSTS' => 'Hosts',
# ORPHANED (no longer in portforwarding_en.lex; kept for reference, commented out by lex-to-po.pl): 'pf_ERR_NO_MASQ_RECORD' => 'Tidak dapat mengambil masq record dari configuration database.',
# ORPHANED (no longer in portforwarding_en.lex; kept for reference, commented out by lex-to-po.pl): 'pf_ERR_UNSUPPORTED_MODE' => 'Mode tidak didukung.',
# ORPHANED (no longer in portforwarding_en.lex; kept for reference, commented out by lex-to-po.pl): 'pf_ERR_CANNOT_REMOVE_NORULE' => 'Tidak dapat menghapus aturan yang tidak eksis.',
...
# ORPHANED (no longer in portforwarding_en.lex; kept for reference, commented out by lex-to-po.pl): 'pf_ERR_DUPRULE' => 'Aturan ini telah ditambahkan, tidak bisa ditambahkan dua kali.',
