...
'prt_ERR_UNEXPECTED_NAME' => ' <p>Σφάλμα: μη-αναμενόμενοι χαρακτήρες στην ονομασία εκτυπωτή.</p> <p>Η ονομασία του εκτυπωτή πρέπει να περιέχει μόνο πεζά γράμματα και αριθμούς και να αρχίζει με πεζό γράμμα. Για παράδειγμα οι ονομασίες "hplaser", "epsonlp", καί "canonbj" αποτελούν έγκυρες επιλογές.</p> ',
