...
'log_LOG_FILE_EMPTY' => 'Loggfilen "[_1]" är tom!',
'log_VIEWING_TIME' => 'Granskad kl [_1].',
'log_MATCH_HEADER' => 'Visar rader som matchar: "[_1]".',
'log_HIGHLIGHT_HEADER' => 'Highlighta rader som matchar: "[_1]".',
'log_NO_MATCHING_LINES' => 'Inga matchande linjer visas.',
'log_FILENAME_ERROR' => ' Fel vid angivandet av namnet på loggfilen.

  <p>Ogiltig rapporttyp "[_1]".</p>
...
'log_DOWNLOAD_PAGE_DESC' => ' Din loggfil förbereds nu. Processen kommer att fortsätta så snart du klickar på &quot;Nästa&quot;-knappen nedan och du tillåter din webbläsare att ladda ner filen via det pop-up fönster som kommer fram.
  ...
  ',
'log_DOWNLOAD_FILE' => 'Förbereder att ladda ner loggfilen [_1].',
'log_FORM_TITLE' => 'Visa loggfiler',
