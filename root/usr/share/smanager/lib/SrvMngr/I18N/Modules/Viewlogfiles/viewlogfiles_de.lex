...
'log_MATCH_PATTERN_DESC' => ' <p>Sie haben optional auch die Möglichkeit, sich zusätzlich Zeilen in Fettdruck anzeigen zu lassen, welche den markierten Mustern entsprechen. Das Markiermuster wird auf alle Zeilen angewendet, die von dem Filtermuster bereits erkannt wurden. Diese Funktion steht beim Herunterladen von Log Dateien nicht zur Verfügung.</p> ',
...
'log_LOG_FILE_EMPTY' => 'Die Log Datei "{$filename}" ist leer!',
'log_VIEWING_TIME' => 'Angesehen am {$time}.',
'log_MATCH_HEADER' => 'Angezeigte Zeilen entsprechen: "{$matchPattern}".',
'log_HIGHLIGHT_HEADER' => 'Markierte Zeilen entsprechen: "{$highlightPattern}".',
'log_NO_MATCHING_LINES' => 'Es werden keine passenden Zeilen angezeigt.',
'log_FILENAME_ERROR' => ' <p>Fehler bei der Eingabe des Log Dateinamens.</p> <p>Ungültiger Berichtstyp "{$filename}".</p> ',
