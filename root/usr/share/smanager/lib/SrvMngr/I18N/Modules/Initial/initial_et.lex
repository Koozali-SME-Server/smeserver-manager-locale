...
'initial_FRAMES_BODY' => ' <p> Tere tulemast SME Server-isse, tegemist on juhtiva Linuxi distributsiooniga väikesele ja keskmise suurusega ettevõttele. SME Server is brought to you by <a href="https://www.koozali.org/" target="_blank">Koozali Foundation, Inc.</a>, a non-profit corporation that exists to provide marketing and legal support for SME Server. </p>
  ...
  <p> As such, we ask for a small donation to offset costs and fund further development. </p>

  <p> <b> Palun külasta <a href="https://wiki.koozali.org/donate" target="_blank">https://wiki.koozali.org/Donate</a> toetamaks serveri arendust. </b></p>

  <p> This software comes with ABSOLUTELY NO WARRANTY. Please <a href="/smanager/support" target="main">click here</a> to view detailed support, warranty and licensing information. </p>
