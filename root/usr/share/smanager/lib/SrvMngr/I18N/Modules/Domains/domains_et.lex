'dom_FORM_TITLE' => 'Domeenide haldamine',
...
'dom_SUCCESSFULLY_CREATED' => 'Domeen [_1] edukalt kustutatud. Sinu veebiserver taaskäivitatakse. See link pole aktiivne seni kuni veebiserveri taaskäivitus on lõpetatud.',
'dom_MODIFY_TITLE' => 'Muuda domeeni',
'dom_NONEXISTENT_DOMAIN_ERROR' => '(en)Error: [_1] is not an existing domain.',
'dom_SUCCESSFULLY_MODIFIED' => 'Domeen [_1] edukalt kustutatud. Sinu weebiserver taaskäivitatakse. See link pole aktiivne seni kuni weebiserveri taaskäivitus on lõpetatud.',
...
'dom_DOMAINS_PAGE_CORPORATE_DNS' => 'Muuda ettevõtte DNS-i sätteid',
