...
'log_LOG_FILE_EMPTY' => 'Le fichier journal "[_1]" est vide !',
'log_VIEWING_TIME' => 'Affiché le [_1].',
'log_MATCH_HEADER' => 'Affichage des lignes qui concordent avec "[_1]".',
'log_HIGHLIGHT_HEADER' => 'Surbrillance des lignes qui concordent avec "[_1]".',
...
'log_FILENAME_ERROR' => ' Erreur de spécification du nom de fichier journal.
  ...
  <p>Type de rapport non valide pour "[_1]".</p>
