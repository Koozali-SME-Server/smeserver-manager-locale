...
# ORPHANED (no longer in ibays_en.lex; kept for reference, commented out by lex-to-po.pl): 'iba_PUBLIC_ACCESS_DESCRIPTION' => 'Genel erişim modu "yerel ağ dışında şifre gerekir" FTP sunucusu bileşeni tarafından desteklenmemektedir şifre gereklidir. Bu modu seçerseniz, FTP sunucusuna parola gerek içeriden ve dışarıdan bu i-bay\'a erişebilirsiniz.',
...
# ORPHANED (no longer in ibays_en.lex; kept for reference, commented out by lex-to-po.pl): 'iba_VIRTUAL_HOST_MESSAGE' => 'Bazı alan adları bu i-bay\'ı kullanıyor, silindiğinde bunu kullanan alan adları birincil i-bay\'a bağlanacaktır (daha sonra onları istediğiniz başka birine bağlayabilirsiniz).',
...
# ORPHANED (no longer in ibays_en.lex; kept for reference, commented out by lex-to-po.pl): 'iba_IBAY_PASSWD_VALIDATION_ERROR' => 'Şifre sadece harfler ve rakamlardan oluşmalıdır.',
...
# ORPHANED (no longer in ibays_en.lex; kept for reference, commented out by lex-to-po.pl): 'iba_Information bays' => 'i-bay (bilgi yuvaları)',
...
# ORPHANED (no longer in ibays_en.lex; kept for reference, commented out by lex-to-po.pl): 'iba_INVALID_IBAY_DESCRIPTION' => 'Hata: i-bay açıklamasında geçersiz karakter bulunuyor',
...
# ORPHANED (no longer in ibays_en.lex; kept for reference, commented out by lex-to-po.pl): 'NONE' => 'Erişim yok',
# ORPHANED (no longer in ibays_en.lex; kept for reference, commented out by lex-to-po.pl): 'LOCAL_NETWORK_NO_PASSWORD' => 'Yerel ağ (parola gerekmez)',
# ORPHANED (no longer in ibays_en.lex; kept for reference, commented out by lex-to-po.pl): 'LOCAL_NETWORK_PASSWORD' => 'Yerel ağ (parola gerekli)',
# ORPHANED (no longer in ibays_en.lex; kept for reference, commented out by lex-to-po.pl): 'ENTIRE_INTERNET_NO_PASSWORD' => 'Tüm İnternet (parola gerekmez)',
# ORPHANED (no longer in ibays_en.lex; kept for reference, commented out by lex-to-po.pl): 'ENTIRE_INTERNET_PASSWORD' => 'Tüm İnternet (parola gerekli)',
