...
'dom_DOMAIN_NAME_VALIDATION_ERROR' => 'Error: terdapat karakter yang tidak dibolehkan atau hilang dalam nama domain [_1]. Nama domain hanya boleh terdiri dari satu atau lebih huruf, angka, titik dan tanda minus. Gagal membuat domain baru.',
'dom_DOMAIN_DESCRIPTION_VALIDATION_ERROR' => 'Error: terdapat karakter yang tidak dibolehkan atau hilang dalam deskripsi domain [_1]. . Gagal membuat domain baru.',
'dom_DOMAIN_IN_USE_ERROR' => 'Error: domain [_1] sudah digunakan. Gagal membuat domain baru.',
'dom_SYSTEM_DOMAIN_ERROR' => 'Error: domain [_1] adalah nama domain dari sistem anda. Anda tidak dapat memiliki domain dengan nama rangkap. Gagal membuat doamin baru.',
'dom_SUCCESSFULLY_CREATED' => 'Berhasil membuat domain [_1]. Web server anda sedang di-restart. Link pada halaman ini akan tidak aktif sampai proses restart web server selesai.',
'dom_MODIFY_TITLE' => 'Ubah domain',
'dom_NONEXISTENT_DOMAIN_ERROR' => 'Error: [_1] tidak ada.',
'dom_SUCCESSFULLY_MODIFIED' => 'Sukses mengubah domain [_1]. Web server sedang di-restart. Link di halaman ini akan akan nonaktif sampai prosest restart web server selesai.',
'dom_REMOVE_TITLE' => 'Hapus domain',
'dom_REMOVE_DESCRIPTION' => '  Anda akan menghapusdomain [_1] ([_2]). 
...
'dom_DOMAINS_PAGE_CORPORATE_DNS' => 'Ubah pengaturan DNS perusahaan',
