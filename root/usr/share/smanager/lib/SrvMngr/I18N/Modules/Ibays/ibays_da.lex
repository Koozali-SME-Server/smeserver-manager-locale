...
'iba_PUBLIC_ACCESS_DESCRIPTION' => 'Offentlig adgangsformen "adgangskode påkrævet udenfor lokalnet" er ikke understøttet af FTP-serveren. Vælger du denne form vil adgangskode være påkrævet både indenfor og udenfor lokalnettet for denne i-bay.',
...
'iba_REMOVE_DESC' => ' <p> Du er ved at fjerne I-bay "{$name}" ({$description}). </p> <p> Alle filer i denne i-bay vil blive slettet. </p> <p> Er du sikker på du ønsker at slette denne i-bay? </p> ',
