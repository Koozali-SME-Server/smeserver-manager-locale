...
'initial_FRAMES_BODY' => '  Üdvözli az SME Server, a piacvezető linux disztribúció kis és középvállalkozások számára. Az SME Server-t az <a href="https://www.koozali.org/" target="_blank">Koozali Foundation, Inc.</a> biztosítja az ön számára, amely egy olyan non-profit szervezet, amely azért jött létre, hogy értékesítési, és jogi támogatást nyújtson az SME Server számára. 
  ...
  <p> Ezért kiadásaink ellensúlyozására és a további fejlesztések támogatására szívesen fogadjuk pénzbeli támogatását. </p>

  <p> <b> Kérjük látogassa meg <a href="https://wiki.koozali.org/donate" target="_blank">https://wiki.koozali.org/Donate</a> weboldalt adománya elküldéséhez. </b></p>

  <p> Ez a szoftver SEMMILYEN GARANCIÁT NEM TARTALMAZ. Kérjük <a href="/smanager/support" target="main">kattintson ide</a> a részletes terméktámogatási, garancia és licensz információkért. </p>
