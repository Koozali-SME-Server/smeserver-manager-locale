...
'grp_ACCOUNT_CONFLICT' => 'Error: the group "{$group}" can\'t be created because there is already a {$type} account of that name.',
...
'grp_GROUP_NAMING' => ' The group name should contain only lower-case letters, numbers, hyphens, periods, and underscores, and should start with a lower-case letter. For example "sales", "beta5", and "reseller_partners" are all valid group names, but "3rd-event", "Marketing Team" and "lost&found" are not. ',
...
'grp_CONFIRM_DELETE_GROUP' => ' <p><b>Are you sure you wish to remove this group?</b></p>

  ',
'grp_CURRENT_LIST' => '<p>Current list of User Groups</p>
