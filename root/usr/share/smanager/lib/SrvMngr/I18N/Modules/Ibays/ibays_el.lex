...
'iba_REMOVE_DESC' => ' <p> Πρόκειται να διαγράψετε το i-bay "{$name}" ({$description}). </p> <p> Όλα τα αρχεία που ανήκουν σε αυτό το i-bay θα διαγραφούν. </p> <p> Είστε σίγουροι ότι θέλετε να διαγράψετε το συγκεκριμένο i-bay; </p> ',
