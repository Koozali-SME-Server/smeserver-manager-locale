...
'iba_CANT_FIND_IBAY' => 'A {$name} névhez nem található felhasználói fiók (létezik?)',
'iba_CANT_CREATE_IBAY' => 'A {$name} névhez nem lehet fiókot létrehozni (már létezik?)',
...
'iba_PASSWORD_DESC' => 'Most készül megváltoztatni a {$name} nevű adattár jelszavát.',
