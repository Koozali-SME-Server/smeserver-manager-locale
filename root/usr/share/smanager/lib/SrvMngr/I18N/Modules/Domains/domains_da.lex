...
'dom_DOMAIN_NAME_VALIDATION_ERROR' => 'Fejl: uventede eller manglende tegn i domænenavn [_1]. Domænenavnet skal indeholde et eller flere bogstaver, tal, punktum eller bindestreger. Domænet blev ikke oprettet.',
'dom_DOMAIN_DESCRIPTION_VALIDATION_ERROR' => 'Fejl: uventede eller manglende tegn i domænebeskrivelsen [_1]. Domænet blev ikke oprettet.',
'dom_DOMAIN_IN_USE_ERROR' => 'Fejl: domænenavn [_1] er allerede i brug. Domænet blev ikke oprettet.',
'dom_SYSTEM_DOMAIN_ERROR' => 'Fejl: domænenavn [_1] er dit systems domænenavn. Du kan ikke have flere domæner med samme navn. Domænet blev ikke oprettet.',
'dom_SUCCESSFULLY_CREATED' => 'Virtuelt domæne [_1] er oprettet. Webserveren vil blive gensartet. Genvejene på denne side vil ikke være inaktive indtil webserveren kører igen.',
'dom_MODIFY_TITLE' => 'Ændre virtuelt domæne',
'dom_NONEXISTENT_DOMAIN_ERROR' => 'Fejl: [_1] findes ikke.',
'dom_SUCCESSFULLY_MODIFIED' => 'Virtuelt domæne [_1] er ændret. Webserveren vil blive gensartet. Genvejene på denne side vil være inaktive indtil webserveren kører igen.',
'dom_REMOVE_TITLE' => 'Remove virtual domain',
'dom_REMOVE_DESCRIPTION' => '  Du er ved at fjerne domænet [_1] ([_2]). 
...
'dom_DOMAINS_PAGE_CORPORATE_DNS' => 'Rediger virksomhedens DNS-indstillinger',
