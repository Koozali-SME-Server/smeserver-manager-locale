'pwd_DESCRIPTION' => ' Hesap şifrenizi değiştirmek için lütfen aşağıdaki formu doldurun. Gerkli bilgiler kullanıcı adınız, eski şifreniz, belirleyeceğiniz yeni şifreniz. (Yeni şifrenizi iki kez girmeniz gerekecek.) Eski şifrenizi unuttuysanız yeni şifre atayamazsınız, sistem yöneticiniz sistem yönetimi. ',
...
'pwd_FIELDS_REQUIRED' => 'Tüm alanlar zorunludur',
...
'pwd_PASSWORD_CHANGE' => 'Şifre Değiştir',
# ORPHANED (no longer in userpassword_en.lex; kept for reference, commented out by lex-to-po.pl): 'pwd_RESET_PASSWORD_TITLE' => 'Kullanıcı parolasını sıfırla',
'pwd_ACCOUNT_PASSWORD_CHANGE' => 'Hesap parolasını değiştir',
'pwd_PASSWORD_VERIFY_NEW' => 'Yeni şifre (doğrulayın):',
'pwd_PASSWORD_NEW' => 'Yeni şifre:',
'pwd_PASSWORD_OLD' => 'Eski şifre:',
'pwd_PASSWORD_RESET' => 'Şifreyi sıfırla',
