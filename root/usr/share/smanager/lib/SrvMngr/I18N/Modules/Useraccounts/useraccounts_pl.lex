...
'usr_ACCOUNT_NAME' => 'Nazwa konta',
'usr_FIRSTNAME' => 'Imię',
'usr_LASTNAME' => 'Nazwisko',
'usr_DEPARTMENT' => 'Dział',
'usr_COMPANY' => 'Firma',
'usr_STREET_ADDRESS' => 'Adres ulicy',
'usr_CITY' => 'Miasto',
'usr_PHONE_NUMBER' => 'Numer telefonu',
'usr_EMAIL_DELIVERY' => 'Dostarczanie e-maili',
'usr_DELIVER_EMAIL_LOCALLY' => '(en)Deliver email locally',
'usr_FORWARD_EMAIL' => '(en)Forward email to address below',
'usr_DELIVER_AND_FORWARD' => '(en)Both deliver locally and forward',
'usr_FORWARDING_ADDRESS' => 'Adres przekazywania',
'usr_GROUP_MEMBERSHIPS' => 'Członkostwo w grupach',
...
# ORPHANED (no longer in useraccounts_en.lex; kept for reference, commented out by lex-to-po.pl): 'usr_LOCK_ACCOUNT' => 'Zablokuj konto',
...
# ORPHANED (no longer in useraccounts_en.lex; kept for reference, commented out by lex-to-po.pl): 'usr_Users' => 'Użytkownicy',
...
'usr_ADD_USER' => 'Dodaj konto użytkownika',
