...
'dom_DOMAIN_NAME_VALIDATION_ERROR' => 'Fel: Ogiltigt eller saknat tecken i domännamnet [_1]. Domännamnet måste innehålla en eller flera bokstäver, siffror, punkter eller minustecken. Skapade inte en ny domän.',
'dom_DOMAIN_DESCRIPTION_VALIDATION_ERROR' => 'Fel: Ogiltigt eller saknat tecken i domänbeskrivningen [_1]. Skapade inte en ny domän.',
'dom_DOMAIN_IN_USE_ERROR' => 'Fel: Domänen [_1] används redan. Skapade inte en ny domän.',
'dom_SYSTEM_DOMAIN_ERROR' => 'Fel: Domänen [_1] är ditt systems domännamn. Du kan inte ha en domän med samma namn. Skapade inte en ny domän.',
'dom_SUCCESSFULLY_CREATED' => 'Skapat den nya domänen [_1]. Din webb-server startas nu om. Länkarna på denna sida kommer att vara inaktiva tills dess att webb-serverns omstart är klar.',
'dom_MODIFY_TITLE' => 'Ändra domän',
'dom_NONEXISTENT_DOMAIN_ERROR' => 'Fel: [_1] är inte en existerande domän.',
'dom_SUCCESSFULLY_MODIFIED' => 'Domänen ändrad [_1]. Din webb-server startas nu om. Länkarna på denna sina är inaktiva tills webb-serverns omstart är klar.',
'dom_REMOVE_TITLE' => 'Radera domän',
'dom_REMOVE_DESCRIPTION' => '  Du håller på att radera den domänen [_1] ([_2]). 
...
'dom_DOMAINS_PAGE_CORPORATE_DNS' => 'Ändra företagets DNS-inställningar',
